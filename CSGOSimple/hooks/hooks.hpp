...
namespace hooks
{
	...
	using get_eye_angles_t = qangle_t * (__fastcall*) (uintptr_t, uintptr_t);
	...
	void __fastcall hk_check_file_crcs_with_server(void* ecx, void* edx);
	bool __fastcall hk_loose_file_allowed(void* ecx, void* edx);
