...
qangle_t* __fastcall hooks::hk_get_eye_angles ( uintptr_t ecx, uintptr_t edx )
{
    ...
    static auto ret_to_thirdperson_pitch = g_utils.pattern_scan ( xor_str ( "client.dll" ),
                                                                  xor_str ( "8B CE F3 0F 10 00 8B 06 F3 0F 11 45 ? FF 90 ? ? ? ? F3 0F 10 55 ?" ) );
    static auto ret_to_thirdperson_yaw = g_utils.pattern_scan ( xor_str ( "client.dll" ), xor_str ( "F3 0F 10 55 ? 51 8B 8E ? ? ? ?" ) );
