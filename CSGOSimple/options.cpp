...
void c_config::setup_config ( )
{
    ...
    // esp
    //
    set ( xor_str ( "esp_master" ), &g_options.esp_master, false);
    set ( xor_str ( "esp_local_box" ), &g_options.esp_local_box, false);
    set ( xor_str ( "esp_enemy_box" ), &g_options.esp_enemy_box, false);
    set ( xor_str ( "esp_enemy_health" ), &g_options.esp_enemy_health, false);
    set ( xor_str ( "esp_enemy_armor" ), &g_options.esp_enemy_armor, false );
    set ( xor_str ( "esp_enemy_flag_scoped" ), &g_options.esp_enemy_flag_scoped, false);
    set ( xor_str ( "esp_enemy_flag_fake" ), &g_options.esp_enemy_flag_fake, false);
    set ( xor_str ( "esp_enemy_flag_reloading" ), &g_options.esp_enemy_flag_reloading, false);
    set ( xor_str ( "esp_enemy_name" ), &g_options.esp_enemy_name, false);
    set ( xor_str ( "esp_enemy_weapon" ), &g_options.esp_enemy_weapon, false);
    set ( xor_str ( "esp_team_box" ), &g_options.esp_team_box, false);
    // world
    set ( xor_str ( "esp_world_weapons" ), &g_options.esp_world_weapons, false);
    set ( xor_str ( "esp_weapon_box" ), &g_options.weapon_box, false );
    set ( xor_str ( "esp_world_weapons_ammo" ), &g_options.esp_world_weapons_ammo, false);
    //
    // chams
    //
    set ( xor_str ( "chams_master" ), &g_options.chams_master, false);
    set ( xor_str ( "chams_fake_desync" ), &g_options.chams_fake_desync, false);
    set ( xor_str ( "chams_fake_pos" ), &g_options.chams_fake_pos, false);
    set ( xor_str ( "color_chams_fake_desync" ), &g_options.color_chams_fake_desync, Color ( 255, 255, 255, 255 ) );
    set ( xor_str ( "color_chams_fake_pos" ), &g_options.color_chams_fake_pos, Color (255, 255, 255, 255) );
    set ( xor_str ( "color_chams_backtrack" ), &g_options.color_chams_backtrack, Color ( 255, 255, 255, 255 ) );

    set ( xor_str ( "chams_local" ), &g_options.chams_local, false);
    set ( xor_str ( "chams_fake_local" ), &g_options.chams_fake_local, false);
    set ( xor_str ( "chams_enemy" ), &g_options.chams_enemy, false);
    ...
    set ( xor_str ( "chams_color_local" ), &g_options.chams_color_local, Color (255, 255, 255, 255) );
    set ( xor_str ( "chams_color_enemy" ), &g_options.chams_color_enemy, Color (255, 255, 255, 255) );
    set ( xor_str ( "chams_enemy_backtrack" ), &g_options.chams_enemy_backtrack, false);
    set ( xor_str ( "chams_color_team" ), &g_options.chams_color_team, Color (255, 255, 255, 255) );
    set ( xor_str ( "chams_color_xqz_local" ), &g_options.chams_color_xqz_local, Color::white );
    set ( xor_str ( "chams_color_xqz_enemy" ), &g_options.chams_color_xqz_enemy, Color (255, 255, 255, 255) );
    set ( xor_str ( "chams_color_xqz_team" ), &g_options.chams_color_xqz_team, Color::white );
    //
    // visuals
    //
    set ( xor_str ( "visuals_local_lc" ), &g_options.visuals_local_lc, false);
    set ( xor_str ( "visuals_local_desync" ), &g_options.visuals_local_desync, false);
    //set ( xor_str ( "visuals_scope_overlay_mode" ), &g_options.visuals_scope_overlay_mode, 2 );
    set ( xor_str ( "visuals_remove_scope_zoom" ), &g_options.visuals_remove_scope_zoom, false);
    ...
    set ( xor_str ( "visuals_nightmode" ), &g_options.visuals_nightmode, false);
    set ( xor_str ( "visuals_nightmode_alpha" ), &g_options.visuals_nightmode_alpha, 1.0f );
    set ( xor_str ( "visuals_radar" ), &g_options.visuals_radar, false);
    set ( xor_str ( "visuals_footstep_esp" ), &g_options.visuals_footstep_esp, false);
    set ( xor_str ( "visuals_footstep_esp_color" ), &g_options.visuals_footstep_esp_color, Color ( 255, 255, 255, 255 ) );
    set ( xor_str ( "visuals_beam_color_bulle" ), &g_options.visuals_beams_bullet_tracer, Color (255, 255, 255, 255 ) );
    set ( xor_str ( "visuals_bullet_tracers" ), &g_options.visuals_bullet_tracers, false);
    set ( xor_str ( "visuals_nosmoke_mode" ), &g_options.visuals_nosmoke_mode, 0 );
    set ( xor_str ( "visuals_crosshair" ), &g_options.visuals_crosshair, false);
    ...
    set ( xor_str ( "visuals_thirdperson_distance" ), &g_options.visuals_thirdperson_distance, 0.f );
    set ( xor_str ( "visuals_noflash" ), &g_options.visuals_noflash, false);
    set ( xor_str ( "visual_beam_ring_size" ), &g_options.visuals_beam_ring_size, 0.f );
    set ( xor_str ( "visual_beam_speed" ), &g_options.visuals_beam_speed, 0.f );
    set ( xor_str ( "visuals_offscreen" ), &g_options.esp_offscreen, false);
    ...
    // ragebot
    //
    set ( xor_str ( "ragebot_master" ), &g_options.ragebot_master, false);
    set ( xor_str ( "ragebot_resolver" ), &g_options.ragebot_resolver, false );
    set ( xor_str ( "ragebot_autoshoot" ), &g_options.ragebot_autoshoot, false);
    ...
    set ( xor_str ( "ragebot_resolver_baim" ), &g_options.ragebot_resolver_baim, false);
    ...
    // main settings
    set ( xor_str ( "ragebot_min_damage" ), &g_options.ragebot_min_damage, 0 );
    set ( xor_str ( "ragebot_hitchance" ), &g_options.ragebot_hitchance, 0.0f );
    set ( xor_str ( "ragebot_hitbox_head" ), &g_options.ragebot_hitbox_head, false);
    set ( xor_str ( "ragebot_hitbox_neck" ), &g_options.ragebot_hitbox_neck, false);
    set ( xor_str ( "ragebot_hitbox_stomach" ), &g_options.ragebot_hitbox_stomach, false);
    set ( xor_str ( "ragebot_hitbox_chest" ), &g_options.ragebot_hitbox_chest, false);
    set ( xor_str ( "ragebot_hitbox_feet" ), &g_options.ragebot_hitbox_feet, false);
    set ( xor_str ( "ragebot_hitbox_arms" ), &g_options.ragebot_hitbox_arms, false );
    set ( xor_str ( "ragebot_hitbox_head_scale" ), &g_options.ragebot_hitbox_head_scale, 0.0f );
    set ( xor_str ( "ragebot_hitbox_body_scale" ), &g_options.ragebot_hitbox_body_scale, 0.0f );
    ...
    set ( xor_str ( "ragebot_shooting_mode" ), &g_options.ragebot_shooting_mode, 0 );
    set ( xor_str ( "ragebot_baim_mode" ), &g_options.ragebot_baim_mode, 0 );
    set ( xor_str ( "ragebot_baim_after_shots" ), &g_options.ragebot_baim_after_shots, 0 );
    set ( xor_str ( "ragebot_baim_when_lethal" ), &g_options.ragebot_baim_when_lethal, false);
    // anti-aim
    set ( xor_str ( "ragebot_antiaim_disable_on_knife" ), &g_options.ragebot_antiaim_disable_on_knife, false );
    set ( xor_str ( "ragebot_antiaim_enable" ), &g_options.ragebot_antiaim_enable, false);
    ...
    set ( xor_str ( "ragebot_antiaim_yaw_jitter_range" ), &g_options.ragebot_antiaim_yaw_jitter_range, 0.f );
    set ( xor_str ( "ragebot_antiaim_yaw_switch_range" ), &g_options.ragebot_antiaim_yaw_switch_range, 0.f );
    ...
    */
    set ( xor_str ( "ragebot_fakelag_standing_ticks" ), &g_options.ragebot_fakelag_standing_ticks, 0 );
    set ( xor_str ( "ragebot_fakelag_moving_ticks" ), &g_options.ragebot_fakelag_moving_ticks, 0 );
    set ( xor_str ( "ragebot_fakelag_slowwalk_ticks" ), &g_options.ragebot_fakelag_slowwalk_ticks, 0 );
    set ( xor_str ( "ragebot_fakelag_while_shooting" ), &g_options.ragebot_fakelag_while_shooting, false);
    //
    // misc
    //
    set ( xor_str ( "misc_bhop" ), &g_options.misc_bhop, false);
    set ( xor_str ( "misc_autostrafer" ), &g_options.misc_autostrafer, false);
    set ( xor_str ( "misc_eventlog" ), &g_options.misc_eventlog, false);
    set ( xor_str ( "misc_clangtag_changer" ), &g_options.misc_clangtag_changer, false );
    set ( xor_str ( "misc_clantag_changer_speed" ), &g_options.misc_clantag_changer_speed, 0.0f );
